...
$(OBJECTOUTDIR)/program.cpp.bin: test.c
	@echo "Compiling program"
	$(CXX) $(CXXFLAGS) $(INCDIRS) -c -o $(OBJECTOUTDIR)/program.o test.c
	@echo
	@echo "Linking program"
	$(CXX) $(LINKFLAGS) -Wl,-Map,$(OBJECTOUTDIR)/program.cpp.map -o $(OBJECTOUTDIR)/program.cpp.elf -lm -lgcc -mthumb -Wl,--start-group $(OBJECTOUTDIR)/syscalls_sam3.c.o $(OBJECTOUTDIR)/program.o $(SAMDIR)/variants/arduino_due_x/libsam_sam3x8e_gcc_rel.a $(OBJECTOUTDIR)/core.a -Wl,--end-group 
	@echo
